<template>
  <div class="cash-index">
    ...
    <nut-tabbar @tab-switch="tabSwitch" unactive-color="#3b3b3b" active-color="#3db778" :safe-area-inset-bottom="true"
      :bottom="true">
      <nut-tabbar-item tab-title="明细" :img="DetailImg" :activeImg="DetailSelectorImg" />
      <nut-tabbar-item tab-title="统计" :img="TotalImg" :activeImg="TotalSelectorImg" />
      <nut-tabbar-item tab-title="设置" :img="SettingImg" :activeImg="SettingSelectorImg" />
    </nut-tabbar>
  </div>
</template>
